...
TCHAR szClassNme[] = _T("HelloDrawString20160630");
...
void OnPaint(HDC hdc)
{
	...
	g.DrawString(_T("ＭＳ ゴシックである。"), -1, &font, RectF(0.0f, 0.0f, 200.0f, 300.0f), &format, &blackBrush);
